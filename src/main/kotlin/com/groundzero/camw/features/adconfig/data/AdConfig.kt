...
data class AdConfig(
    /**
     * Frequency of 2 means that user will see AppOpenAd every second app opening.
     * To remove AppOpenAd, frequency should be set to 0.
     */
    val appOpenAdFrequency: Int = 0,
