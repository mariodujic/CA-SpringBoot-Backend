...
class ChatRoomPeriodicCacheServiceImpl(
     ...
     */
    override fun retrieveMessagesFromPersistentStorage() {
     ...
     */
    override fun storeMessagesFromMemoryToPersistentStoragePeriodically() {
